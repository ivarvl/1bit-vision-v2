...
class Attention(nn.Module):
    def __init__(
        ...
        if self.attn_bias:  # dense bias
            ...
            self.num_relative_distance = (2 * input_size[0] - 1) * (
                2 * input_size[1] - 1
            ) + 3
            ...
            relative_position_index = torch.zeros(
                size=(input_size[0] * input_size[1] + 1,) * 2,
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            attn_quant: (bool) quantize query and key into binary representations
            attn_bias: (bool) add a bias
            pv_quant: (bool) quantize p and value into 8-bit
        """
        super().__init__()
    ...
    def no_weight_decay(self):
        ...
        no_decay = {"pos_embed", "cls_token", "dist_token"}
